        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="relative h-40 lg:h-30 bg-slate-800/50 rounded-2xl border border-purple-500/20 overflow-hidden backdrop-blur-sm flex flex-col items-center justify-center">
              ...
              {/* Texto ajustado solo en pantallas pequeñas */}
              <div className="p-4 md:p-8 text-center md:text-left w-full md:absolute md:bottom-0 md:left-0 md:right-0 md:bg-gradient-to-t md:from-slate-900 md:to-transparent">
