...
export default function ContactSection() {
  ...
  return (
    <section id="contacto" className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl w-full relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            {/* Map */}
            <div className="relative h-64 bg-slate-800/50 rounded-2xl border border-purple-500/20 overflow-hidden backdrop-blur-sm group">
              <div className="absolute inset-0 flex items-center justify-center">
                <MapPin size={48} className="text-cyan-400 group-hover:scale-125 transition-transform duration-300" />
              </div>
          ...
          {/* Contact Form */}
          <div className="bg-gradient-to-br from-slate-800/50 via-purple-900/30 to-slate-800/50 p-8 md:p-10 rounded-2xl border border-purple-500/20 backdrop-blur-sm relative overflow-hidden group">
