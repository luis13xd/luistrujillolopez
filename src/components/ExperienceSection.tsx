          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              {experienceData.map((exp, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-r from-slate-800/50 to-purple-900/30 p-6 rounded-xl border border-purple-500/20 backdrop-blur-sm hover:border-cyan-400/40 transition-all duration-300 hover:transform hover:scale-105"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              {educationData.map((edu, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-r from-purple-900/30 to-slate-800/50 p-6 rounded-xl border border-cyan-500/20 backdrop-blur-sm hover:border-purple-400/40 transition-all duration-300 hover:transform hover:scale-105"
                >
                  <div className="flex items-start justify-between mb-2">
